...
import com.sfexpress.multishootcamera.cameraview.CameraView
import com.sfexpress.multishootcamera.model.PicUrlData
import com.sfexpress.multishootcamera.model.add
import com.sfexpress.multishootcamera.model.remove
import kotlinx.android.synthetic.main.activity_camera.*
import kotlinx.android.synthetic.main.custom_view_thumbnail_camera.view.*
import kotlinx.android.synthetic.main.view_new_user_guide.view.*
import java.io.File
...
class CameraActivity : AppCompatActivity() {
    ...
    lateinit var previewOverCam: ImageView
    ...
    private fun initView() {
        ...
        thumbnailLayoutParams = LinearLayout.LayoutParams(SizeUtils.dp2px(this, 75f), SizeUtils.dp2px(this, 75f))
...
//                        backgroundHandler?.run { cameraView.takePicture() }
    ...
    private fun initGuideView() {
        ...
        if (readStringInSharedPref(HAS_SHOW_USER_GUIDE).isNullOrEmpty()) {

            val guideView = layoutInflater.inflate(R.layout.view_new_user_guide, null)
            guideView.btn_done.setOnClickListener { delegate.findViewById<ViewGroup>(android.R.id.content)?.removeView(guideView) }
            addContentView(guideView!!, RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT))

            saveStringInSharedPref(HAS_SHOW_USER_GUIDE, "show")
        }
    ...
    private fun addThumbnailFromFile(absUrl: String) {
        ...
        with(layoutInflater.inflate(R.layout.custom_view_thumbnail_camera, null)) {
            ...
            ImageLoaderFactory.getLoader(this@CameraActivity)
                    .displayImage(this.img_content_camera, "file://" + absUrl, DisplayOption.createTransparentOption()
                            .apply {
                                isCenterCrop = true
                                isPreFitXY = false
                                isCircle = false
    ...
    private val thumbnailClickListener = View.OnClickListener { v: View ->
        run {
            ...
            with(previewOverCam) {
                ...
                ImageLoaderFactory.getLoader(this@CameraActivity)
                        .displayImage(this, "file://" + url, DisplayOption.createTransparentOption()
                                .apply {
                                    isPreFitXY = false
                                    isCircle = false
                                })
...
const val HAS_SHOW_USER_GUIDE = "usr_guide"
